...
["_memory","___indirect_function_table","_call_main","onRuntimeInitialized"].forEach((prop) => {
...
function findWasmBinary() {
  ...
  return new URL('gxtool.wasm', import.meta.url).href;
}
...
var _call_main = Module['_call_main'] = createExportWrapper('call_main', 0);
